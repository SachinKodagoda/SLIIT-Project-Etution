    ...
    <div>
        ...
        <form action="<?php echo URLROOT; ?>/user/login" method="post" class="form" id="login_form_submit">
            ...
            <div>
                ...
                <div class="form_login_btn_cover">Don't you have an account? <span onclick="navFunction('<?php echo URLROOT ?>/user/register',true)" class="form_login_btn" style="cursor:pointer;">Register</span></div>
            </div>
        </form>
    </div>
    <!-- <script>

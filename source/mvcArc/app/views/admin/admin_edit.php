    ...
    <div class="clearfix">
        ...
        <div class="rightBody">
            <div class="dashboardItem clearfix">
                ...
                <span class="dashboardItem_topic_version">Edit admin details</span>
            ...
            <div>
                <form action="<?php echo URLROOT; ?>/admin/admin_edit/<?php echo $data['member_id'] ?>" method="post" class="form" id="form_user_edit" style="margin-top: 0">
